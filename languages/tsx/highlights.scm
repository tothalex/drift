; drift's curated tsx highlight stack, layered like an editor: the
; JavaScript base and JSX queries (tree-sitter-javascript v0.25.0),
; the TypeScript query (tree-sitter-typescript v0.23.2), then drift's
; decorator and TypeScript-only supplements.
; Variables
;----------
